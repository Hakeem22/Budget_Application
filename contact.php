...
<div id="container">
    ...
    <form method="post" action="classes/Email.php">
        ...
        <div class="form-group" align="center">
            ...
            <input type="email" class="form-control" name="emailAddress" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Email Address" style="width: 250px">
            <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
        </div>
        <div class="form-group" align="center">
            <label for="formGroupExampleInput">Contact Number:</label>
            <input type="text" class="form-control" name="cnumber" id="mobileNumber" placeholder="Enter Contact Number" style="width: 250px">
        </div>
        <div class="form-group" align="center">
            <label for="formGroupExampleInput">Subject:</label>
            <input type="text" class="form-control" name="subject"  id="subject" placeholder="Enter Subject" style="width: 250px">
        </div>
        <div class="form-group" align="center">
